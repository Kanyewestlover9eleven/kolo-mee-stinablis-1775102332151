...
const basePath = '/kolo-mee-stinablis-1775102332151';
...
export default function Home() {
  ...
  const products = [{ n: 'Product 1', d: 'Kolo Putih: Our signature white kolo mee, tossed in a light and savory sauce, served with tender chicken and crispy shallots.', icon: 'domain' }, { n: 'Product 2', d: 'Kolo Merah: Our spicy red kolo mee, infused with the bold flavors of chili and spices, topped with juicy pork and boiled egg.', icon: 'architecture' }, { n: 'Product 3', d: 'Kolo Kicap: Our sweet and soy-based kolo mee, featuring a rich kicap manis sauce, paired with roasted pork and steamed vegetables.', icon: 'chair' }, { n: 'Product 4', d: 'Wantan: Thin and delicate wantan noodles, served in a flavorful broth with succulent wantans filled with pork and shrimp.', icon: 'eco' }, { n: 'Product 5', d: 'Mee Pok: Our take on the classic mee pok, featuring springy noodles, savory sauce, and a medley of vegetables, meat, and seafood.', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body">
      ...
      <section id="about" className="py-24 bg-surface">
        <div className="max-w-7xl mx-auto px-8">
          ...
          <p className="text-on-surface-variant text-lg max-w-3xl mb-12">Kolo Mee Stinablis is a renowned destination for authentic and delicious kolo mee, dedicated to serving the best traditional Malaysian dishes with a modern twist.</p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div><h4 className="font-bold text-primary">Vision</h4><p className="text-sm text-on-surface-variant">To be the leading provider of high-quality kolo mee and related products, exceeding customer expectations and setting the standard for the industry.</p></div>
            <div><h4 className="font-bold text-primary">Mission</h4><p className="text-sm text-on-surface-variant">To consistently deliver exceptional taste, quality, and service, while promoting the rich cultural heritage of Malaysian cuisine.</p></div>
            <div><h4 className="font-bold text-primary">haha</h4><p className="text-sm text-on-surface-variant">Quality First: We prioritize the use of fresh ingredients, meticulous preparation, and rigorous quality control to ensure every dish meets our high standards.</p></div>
            <div><h4 className="font-bold text-primary">lmao</h4><p className="text-sm text-on-surface-variant">Customer Delight: We strive to create memorable dining experiences, listening to feedback and continuously improving to exceed our customers\' expectations.</p></div>
          </div>
        </div>
      </section>
